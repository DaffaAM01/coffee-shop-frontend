 ...
 const pilihBarang = (id)=>{
  ...
  const tambahBarang = ()=>{
    ...
    const data = barang.find(
      item=>item.id===Number(formData.barang_id)
    );
    if(!data) return;
...
const tambahBarangUpdate = () => {
  ...
  const itemBaru = {
    ...
    subtotal:
      Number(selectedTransaksi.jumlah) *
...
const updateJumlahBarang = (index, jumlah) => {
  ...
  setSelectedTransaksi((prev) => {
    ...
    barangBaru[index].subtotal =
      qty * Number(barangBaru[index].harga);
          ...
          <div className="overflow-x-auto border rounded-xl">
            ...
            <table className="w-full min-w-175">
              ...
              <tbody>
                ...
                {selectedTransaksi?.detail_transaksi?.map((item,index)=>(
                  <tr
                    key={index}
...
>
  ...
  <div className="fixed inset-0 bg-black/50 z-50 flex justify-center items-center p-4">
    <div className="bg-white w-full max-w-6xl rounded-2xl shadow-2xl max-h-[95vh] overflow-hidden">
                    ...
                    <td className="p-3">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          const detailBaru = [...selectedTransaksi.detail_transaksi];

detailBaru[index].jumlah = Number(e.target.value);
